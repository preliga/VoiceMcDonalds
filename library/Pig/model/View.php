...
class View
{
    ...
    public function render(array $data)
    {
        ...
        $this->assignVariableTpl($smarty, $data);
        $this->assignVariableJs($data);
     ...
     * @param array $data
     */
    protected function assignVariableTpl(\Smarty $smarty, array $data)
    {
        $publicVars = create_function('$obj', 'return get_object_vars($obj);');
     ...
     * @param array $data
     */
    protected function assignVariableJs(array $data)
    {
        $publicVars = create_function('$obj', 'return get_object_vars($obj);');
        $result = array_merge($publicVars($this), $data);
